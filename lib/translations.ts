...
export const translations = {
  en: {
    ...
    venueLocation: "Dubai, United Arab Emirates",
    date: "March 22, 2026",
    time: "4:30 PM",
    eventNote: "ملاحظة: زفة العرسان في تمام الساعة 5:00 عصراً، نرجو الحضور مبكراً لتفادي الازدحام المتوقع من حركة المرور",

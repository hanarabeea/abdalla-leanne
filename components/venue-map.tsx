...
export default function VenueMap() {
  ...
  // Google Maps URL for Sheraton Jumeirah Beach Resort
  const googleMapsUrl = "https://maps.app.goo.gl/QVwq3Sb6DzaFcdiG9"
        ...
        <div className="relative group">
          ...
          <div className="relative w-full aspect-video min-h-[250px] rounded-2xl overflow-hidden border-2 border-accent/20 shadow-2xl transition-all duration-300 transform hover:scale-[1.02] cursor-pointer bg-slate-50">
            ...
            <div 
              ...
              role="button"
              tabIndex={0}
              aria-label="Open Sheraton Jumeirah Beach Resort location in Google Maps"
              onKeyDown={(e) => {
            ...
            >
              ...
              <Image
                src={staticMapUrl}
                alt="Sheraton Jumeirah Beach Resort Location - Click to open in Google Maps"
                fill
